...
- demo-microservice1-1.0.0

**Create the docker image**

```bash
  docker build -t lorincetawamba/demo-microservice1:1.0.0 -f Dockerfile .
```
...
```bash
  docker run -d -p 8081:8081 -t lorincetawamba/demo-microservice1:1.0.0
```
...
```bash
  docker image push lorincetawamba/demo-microservice1:1.0.0
```
